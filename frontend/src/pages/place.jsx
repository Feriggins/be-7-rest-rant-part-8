        ...
        <div className="container mt-4">
            <div className="row">
                ...
                <div className="col-md-8">
                    ...
                    <h4 style={{color: "#AADDEA"}}>Rating: <span style={{color: "#000"}}>{averageRating} Stars</span></h4>
                    <div className="mb-4">{renderStars(averageRating)}</div>
                    <h4 style={{color: "#AADDEA"}}>Description</h4>
                    <p className="mb-5">{place.name} has been serving {place.city}, {place.state} since {place.founded}</p>
